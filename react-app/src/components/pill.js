...
export const Pill = ({ children, className }) => {
  ...
  return (
    ...
    >
      <span style={{ '--h': px(hypotenuse), '--hh': px(hypotenuseHalf) }} className="absolute inline-block w-[var(--h)] top-[var(--hh)] left-[var(--hh)] h-[2px] -rotate-45 origin-top -translate-x-1/2 bg-border" />
      <span style={{ '--h': px(hypotenuse), '--hh': px(hypotenuseHalf) }} className="absolute w-[var(--h)] top-[var(--hh)] right-[var(--hh)] h-[2px] bg-border rotate-45 translate-x-1/2" />
      <span style={{ '--h': px(hypotenuse), '--hh': px(hypotenuseHalf) }} className="absolute w-[var(--h)] bottom-[var(--hh)] left-[var(--hh)] h-[2px] bg-border rotate-45 -translate-x-1/2" />
      <span style={{ '--h': px(hypotenuse), '--hh': px(hypotenuseHalf) }} className="absolute w-[var(--h)] bottom-[var(--hh)] right-[var(--hh)] h-[2px] bg-border -rotate-45 translate-x-1/2" />
